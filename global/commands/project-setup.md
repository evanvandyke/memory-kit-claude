...
- All present and correct → tell [USER_NAME] there's nothing to set up. If it's an existing project that may have drifted, point [USER_PRONOUN_OBJECT] to `/project-repair`.
...
Ask [USER_NAME] (skip any [USER_PRONOUN_SUBJECT]'s already given):
